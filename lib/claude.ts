...
const FRUIT_KEYWORDS = ['과일', '제철', '뭐 들어', '입고', '이번 주', '이번주', '박스', '뭐 있', '어떤 과일', '레드향', '한라봉', '천혜향', '딸기', '사과', '귤', '감귤', '예약', '주문', '참외', '수박', '복숭아', '포도', '감', '배', '토마토', '추천', '상품', '뭐 팔', '뭐 파', '뭘 팔', '뭘 파', '어떤 상품', '메뉴', '잘나가', '잘 나가', '인기', '뭐가 좋', '뭐 좋', '요새 뭐', '요즘 뭐', '뭐 먹', '제철이', '뭐 나와', '뭐나와'];
