...
const FRUITS: Record<FruitKey, {
  ...
  레드향: {
    emoji: '🍊',
    img: 'https://lh3.googleusercontent.com/d/1XxIMo4ol2JK068znMQIzsabmzSUP4_nT',
  ...
  한라봉: {
    emoji: '🍊',
    img: 'https://lh3.googleusercontent.com/d/136rBy4Qzs5XIWZwBG_SqOsmzGPbxfnvk',
  ...
  천혜향: {
    emoji: '🍊',
    img: 'https://lh3.googleusercontent.com/d/1yB05WyRn1jfUOvcCaXNuZNZl4l2VbYkf',
  ...
  사과: {
    emoji: '🍎',
    img: 'https://lh3.googleusercontent.com/d/10X4CNixEXXRz1ezhGYjFRQ82wLUvq67J',
  ...
  배: {
    emoji: '🍐',
    img: 'https://lh3.googleusercontent.com/d/1oieTGzHeG8eaD2OUSUWpVWbrUpJiwl9Q',
  ...
  키위: {
    emoji: '🥝',
    img: 'https://lh3.googleusercontent.com/d/1CH-eVxqZplzmWarE3UVPo_HLWawCQZW3',
  ...
  참외: {
    emoji: '🍈',
    img: 'https://lh3.googleusercontent.com/d/1oKUa72hpMIm9s1uqsfXuETP-V3m-Uyx2',
